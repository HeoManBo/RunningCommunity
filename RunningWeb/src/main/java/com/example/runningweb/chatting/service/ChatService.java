...
public class ChatService {
    ...
    public ChatService(@Qualifier("chattingMessageTopic") ChannelTopic topic, RedisTemplate<String, Object> template,
                       RedisChatRoomRepository roomRepository, MessageService messageService) {
        this.topic = topic;
